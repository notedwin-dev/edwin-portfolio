      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Self-taught full-stack developer passionate about building scalable web applications and helping the
              developer community grow.
            </p>            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" className="hover:bg-gray-800 hover:scale-110 transition-all duration-300 group">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-gray-400">
              ...
              variant="outline"
              size="sm"
              className="bg-transparent border-gray-600 text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500 hover:text-white hover:border-transparent hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25"
            >
              Let's Work Together
            </Button>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center">
          ...
          >
            ...
            <span className="group-hover:text-cyan-400 transition-colors duration-300">Back to Top</span>
          </Button>
        </div>
      </div>
    </footer>
